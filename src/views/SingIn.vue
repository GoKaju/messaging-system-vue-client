        ...
        <div id="register">
            <div class="fields">
                ...
                <p>
                    ...
                    <input type="text" id="name" name="username" v-model="input.name" placeholder=""/>
                </p>
                <p>
            ...
            <div class="options">
                <button type="button" v-on:click="singIn()">Registrarme</button>
            </div>
        ...
        methods: {
            singIn() {
                ...
                if (!this.input.password || this.input.password.length < 6) {
                    // @ts-ignore
                    this.errors.push("La contraseña es obligatoria y debe contener al menos 6 caracteres.");
                }
